...
const plus = (n) => function(val) { return val + n}
const minus = (n) =>  function(val) {return val - n}
const times = (n) =>  function(val) {return val * n}
const dividedBy = (n) =>  function(val) {return Math.floor(val / n)}